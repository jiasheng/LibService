            ...
            if (!field.equals("isbn")) {
                ...
                if (res.getStatus().equals("OK")) {
                    ...
                    for (int i = 0; i < res.getTitles().getTitle().size(); i++) {
                        ...
                        out.println("<tr><td>" +(i+1) + "</td><td>" + t.getTitleName() + "</td><td>" + t.getISBN() + "</td><td>" + t.getAuthor() + "</td><td>" + t.getMediaDesc() + "</td>");
                ...
                if (res.getStatus().equals("OK")) {
                    ...
                    sg.gov.nlb.ws.catalogueservice.
                    TitleDetail t = res.getTitleDetail();
